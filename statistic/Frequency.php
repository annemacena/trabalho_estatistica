...
$sql = "SELECT count(*) as qtd_pessoas FROM tb_usuario WHERE failedLogin > 0;";
            ...
            // $saidaP .= "<br><strong>Probabilidade de ser mulher: </strong>".((($totalPessoas - $homem)/$totalPessoas) * 100)." %</div>";
             ...
             $saidaP .= " e sabendo que a quantidade de homens é de ".$homem." e mulheres ".($totalPessoas - $homem).", é de ".$totalPessoas." pessoas, qual a probabilidade um usuário";
             ...
             $saidaP .= "<br><dt>Qual a probabilidade de um homem ter cometido um erro no login dentre as 15 vezes?</dt>";
